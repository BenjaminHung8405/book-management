...
namespace book_management.Data
{
    ...
    {
        /// <summary>
     /// L?y t?t c? sách t? database v?i thông tin tác gi? và th? lo?i
        /// </summary>
        /// <returns>List các dynamic object ch?a thông tin sách</returns>
...
try
 ...
 book.NxbId = reader["nxb_id"] != DBNull.Value ? Convert.ToInt32(reader["nxb_id"]) : 0;
  ...
  return book;
    ...
    {
      throw new Exception($"L?i khi l?y thông tin sách ID {sachId}: {ex.Message}", ex);
   }
